    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <div class="row" style="padding: 0 1.25rem;">
                ...
                <button type="button" class="button btn btn-danger x-small" style="background-color: rgb(199, 83, 83);border: none" id="btn_delete_all">
                    {{ trans('My_Classes_trans.delete_checkbox') }}
                </button>

                    <form action="{{ route('Filter_Classes') }}" method="get" class="mr-0 ml-auto">
                        {{ csrf_field() }}
