...
@section('content')
    ...
    <h5 style="font-family: 'Cairo', sans-serif;color:black;margin-right: 20px"> Today's Date  <span style="font-style: italic;margin-left: 20px;font-weight: bold;color: rgb(67, 140, 185);font-size: 14px">{{ date('Y-m-d') }}</span></h5>
