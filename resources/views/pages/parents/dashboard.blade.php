 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title" >
                <div class="row">
                    <div class="col-sm-6" >
                        <h4 class="mb-0" style="font-family: 'Cairo', sans-serif">All Your Childrens</h4>
                    </div><br><br>
                    <div class="col-sm-6">
                                    ...
                                    <div class="card text-black">
                                        ...
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <p class="text-muted mb-4">Student Informations</p>
                                            </div>
                                            <div>
                                                <div class="d-flex justify-content-between">
                                                    <span>Grade</span><span>{{$son->grade->Name}}</span>
                                                </div>
                                                <div class="d-flex justify-content-between">
                                                    <span>Class</span><span>{{$son->classroom->Name_Class}}</span>
                                                </div>
                                                <div class="d-flex justify-content-between">
                                                    <span>Section</span><span>{{$son->section->Name_Section}}</span>
                                                </div>
