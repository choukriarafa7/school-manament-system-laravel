    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Fees.index')}}">{{trans('Students_trans.study fees')}}</a> </li>
                <li> <a href="{{route('Fees_Invoices.index')}}">{{trans('Students_trans.Invoices')}}</a> </li>
                <li> <a href="{{route('receipt_students.index')}}">{{trans('Students_trans.receipt')}}</a> </li>
                <li> <a href="{{route('ProcessingFee.index')}}">{{trans('Students_trans.exclude fee')}}</a> </li>
                <li> <a href="{{route('Payment_students.index')}}">{{trans('Students_trans.voucher exchange')}}</a> </li>                               
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Attendance.index')}}">Students List</a> </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Subjects">
                <div class="pull-left"><i class="fas fa-book-open"></i><span class="right-nav-text">Subjects List</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
        ...
        <li>
            ...
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Quizzes.index')}}">Exams List</a> </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}">Books List</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('online_classes.index')}}">Online classes with Zoom</a> </li>
            </ul>
        </li>
